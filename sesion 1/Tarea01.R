...
resultados2014 = read_delim("C:/Users/Martín Del Águila/Desktop/Ciclo 7 - Upeu/Análisis Multivariado/Analisis-Multivariado/Tarea01/data/resultados2014.csv", 
                            ",", escape_double = FALSE, trim_ws = TRUE) #insertar datos separados por ,

head(resultados2014) #mostrar datos de resultados2014

resultados2018 = read_delim("C:/Users/Martín Del Águila/Desktop/Ciclo 7 - Upeu/Análisis Multivariado/Analisis-Multivariado/Tarea01/data/resultados2018.csv", 
                            ",", escape_double = FALSE, trim_ws = TRUE) #insertar datos separados por ,
...
##por_resultados2018 = votos_porcentaje(resultados2018) #Metodo para volver el porcentaje a normal
...
library("dplyr")
library("geojsonsf")
codigohasc = read_excel("C:/Users/Martín Del Águila/Desktop/Ciclo 7 - Upeu/Análisis Multivariado/Analisis-Multivariado/Tarea01/data/codigohasc2.xlsx")
View(codigohasc)
...
mapa_resultados <- function(dataframe_mapa, partido, color_high, titulo) {
  ...
  return(
    ggplot() +
      geom_sf(data = cr_mapa, aes(fill = {{ partido }}), color = "black") +
      coord_sf() +
...
mapa_resultados(mapa18, pln18, "black", "PLN 2018")
